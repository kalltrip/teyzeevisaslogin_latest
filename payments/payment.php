...
error_log("payment.php loaded - Session data: " . print_r($_SESSION, true));
error_log("payment.php loaded - Session ID: " . session_id());
...
$requiredFiles = ['database.php', 'user.php', 'logger.php'];
$missingFiles = [];
    ...
    <div class="payment-container">
        ...
        <?php if ($sessionValidationError): ?>
            <div class="error-message">
                ...
                <br><a href="logout.php">Click here to logout and login again</a>
            </div>
        ...
        <?php else: ?>
            ...
            <div style="text-align: center; font-size: 12px; color: #666; margin-top: 20px;">
                ...
                <p>Need help? Contact support at support@teyzeevisas.com</p>
            </div>
        <?php endif; ?>
    </div>
